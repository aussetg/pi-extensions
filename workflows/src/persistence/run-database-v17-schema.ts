export const WORKFLOW_RUN_DATABASE_V17_SCHEMA_VERSION = 4;
export const WORKFLOW_RUN_DATABASE_V17_BUSY_TIMEOUT_MS = 5_000;

/**
 * The v17 database is a clean per-run rebuild. It deliberately has no migration path from the
 * completion-ordered v16 schema: old files remain immutable legacy evidence.
 */
export const WORKFLOW_RUN_DATABASE_V17_SCHEMA_SQL = String.raw`
CREATE TABLE runs (
...
PRAGMA user_version = ${WORKFLOW_RUN_DATABASE_V17_SCHEMA_VERSION};
`;
