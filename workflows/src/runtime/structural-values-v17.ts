...
import type { WorkflowV17ProductIdentity } from "../definition/workflow-language-v17.js";
...
const FORMAT = "workflow-v17-authority-tree";
...
export class WorkflowV17StructuralValueCodec {
  constructor(
    private readonly authority: WorkflowV17ControlAuthorityRegistry,
    private readonly products: WorkflowV17EffectProductFactory,
  ) {
