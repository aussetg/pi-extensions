...
import { createWorkflowV17ControlRealm } from "./control-realm-v17.js";
...
function hardenContext(context) {
  ...
  `, { filename: "workflow-v17-control-lockdown.js" });
...
function startControl() {
  ...
  controlRealm = createWorkflowV17ControlRealm(context, {
