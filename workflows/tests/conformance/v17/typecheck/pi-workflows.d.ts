// Candidate public contract. Step 3 promotes this only after frontend implementation begins.
declare module "pi/workflows" {
  ...
  export interface PassedVerification extends JsonObject {
    passed: true;
    status: "passed";
    receiptId: string;
  }

  export interface NonPassedVerification extends JsonObject {
    passed: false;
