...
export function createWorkflowTool(deps: WorkflowToolDeps): any {
  return {
    ...
    promptSnippet: "Run deterministic JavaScript workflows only for complex/non-standard orchestration that requires multiple isolated Pi subagents; avoid for sequential or single-agent work.",
